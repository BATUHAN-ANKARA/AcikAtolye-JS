//hava durumuna göre kullanıcıya öneride bulunan program
...
//   console.log("güneş gözlüğünü tak ve dışarı çık");
// } else if (anlikHava === "yağmurlu") {
//   console.log("şemsiyeni al ve dışarı çık");
// } else if (anlikHava === "karlı" && yas < 10) {
//   console.log("kar topu savaşına gidebilirisn");
// } else if (anlikHava === "karlı" && yas > 10) {
//   console.log("kar topu savaşına gidemezsin");
// }
...
//   const element = kullanicilar[index];
...
// console.log("Bölünenler:", bolunenler);
// console.log("Bölünmeyenler:", bolunmeyenler);
...
//     console.log(i, j, ".cı eleman:", element[j]);
//   }
// }
...
// for (let index = 0; index < kareler.length; index++) {
//     console.log(kareler[index] ** (1/2));
// }
